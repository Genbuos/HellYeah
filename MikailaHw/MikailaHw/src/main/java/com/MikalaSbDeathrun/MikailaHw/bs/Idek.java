package com.MikalaSbDeathrun.MikailaHw.bs;

import com.MikalaSbDeathrun.MikailaHw.DaBlock.Market;
import com.MikalaSbDeathrun.MikailaHw.Snicker.Ticker;
...
public class Idek {
    ...
    private String allowed_historic_price_variance;
    private String allowed_historic_price_age;
    ...
    public String getAllowed_historic_price_variance() {
        return allowed_historic_price_variance;
    }

    public void setAllowed_historic_price_variance(String allowed_historic_price_variance) {
        this.allowed_historic_price_variance = allowed_historic_price_variance;
    }

    public String getAllowed_historic_price_age() {
        return allowed_historic_price_age;
    }

    public void setAllowed_historic_price_age(String allowed_historic_price_age) {
